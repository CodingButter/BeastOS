...
StartButton = function(props)
    button = Element.createElement("button",{
        id = "startBtn",
        style = {
            width = 7,
            height = 1,
...
BeastOs = function(props)
    return Element.button(
    {
        ...
        onClick = function(self,event)
            props.setText(props.secondText)
        end,
        content = "beast"
    })
end
...
-- require("./src/components/TaskBar/StartButton")
-- require("./src/components/TaskBar/BeastOs")
e = React.Element.new
...
TaskBar = function(props)
    return e("div",{
        ...
        children = {StartButton(props),BeastOs(props)}
    })
end
...
-- require("./modules/React")
-- require("./src/components/TaskBar/TaskBar")
App = function()
